...
- (void)addCircleAnimation {
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:center radius:radius startAngle:-M_PI_2 endAngle:(-M_PI_2+M_PI_2*0.4) clockwise:YES];
    ...
    rotateAnimation.duration = 0.45f;
